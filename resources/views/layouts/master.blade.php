...
<title>FRAMLIL GENERAL ENT</title>
...
<form action="{{ route('logout') }}" method="post">
       @csrf
       <button class="btn btn-success" type="submit"><i class="fa fa-sign-out" aria-hidden="true"></i>Logout</button>
</form>
</div>
</div>
...
<ul class="nav nav-treeview">
<li class="nav-item">
<a href="{{url('farmers/create')}}" class="nav-link">
...
<strong>Copyright &copy; 2014-2022 <a href="https://zinofit.com">Zinofit Technologies</a>.</strong> All rights reserved.
</footer>
</div>
